...
with col1:
    st.image(
        "https://media.istockphoto.com/id/182067740/id/foto/tomat-busuk.jpg?s=612x612&w=0&k=20&c=iCjbpBv6yjXROl1iibuTLtfJ1rkuXt82C3mH5e78gtg=",
        use_column_width=True
    )
    st.markdown("### 🍅 Penyakit Tomat")
...
with col2:
    st.image(
        "https://www.dgwfertilizer.co.id/wp-content/uploads/2020/10/Pupuk-NPK-GOLD-DGW-Pupuk-HX-DAP-768x515.jpg",
        use_column_width=True
    )
    st.markdown("### 🌱 Pupuk Tanaman")
...
with col3:
    st.image(
        "https://img.youtube.com/vi/xxJhFXNpa60/0.jpg",
        use_column_width=True
    )
    st.markdown("### 🎥 Video Edukasi Tomat")
...
# Footer info
st.info("📌 Konten ini dikurasi dari sumber terpercaya seperti Kementerian Pertanian dan video edukatif YouTube.")
